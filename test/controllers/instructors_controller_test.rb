...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { instructor_email: @instructor.instructor_email, instructor_first: @instructor.instructor_first, instructor_id: @instructor.instructor_id, instructor_last: @instructor.instructor_last, instructor_middle: @instructor.instructor_middle } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { instructor_email: @instructor.instructor_email, instructor_first: @instructor.instructor_first, instructor_id: @instructor.instructor_id, instructor_last: @instructor.instructor_last, instructor_middle: @instructor.instructor_middle } }
