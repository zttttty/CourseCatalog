...
class InstructorsTest < ApplicationSystemTestCase
  ...
  test "creating a Instructor" do
    ...
    fill_in "Instructor First", with: @instructor.instructor_first
    fill_in "Instructor", with: @instructor.instructor_id
    fill_in "Instructor Last", with: @instructor.instructor_last
    fill_in "Instructor Middle", with: @instructor.instructor_middle
